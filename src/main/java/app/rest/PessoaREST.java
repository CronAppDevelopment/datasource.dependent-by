...
public class PessoaREST {
  ...
  public HttpEntity<PagedResources<Endereco>> findEndereco(@PathVariable("pessoaId") java.lang.String pessoaId, Pageable pageable, PagedResourcesAssembler assembler) {
  ...
  public Endereco putEndereco(@Validated @RequestBody final Endereco entity, @PathVariable("pessoaId") java.lang.String pessoaId) throws Exception {
  ...
  public Endereco postEndereco(@Validated @RequestBody final Endereco entity, @PathVariable("pessoaId") java.lang.String pessoaId) throws Exception {
  ...
  public Pessoa get(@PathVariable("pessoaId") java.lang.String pessoaId) throws Exception {
