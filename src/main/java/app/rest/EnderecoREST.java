...
public class EnderecoREST {
  ...
  public HttpEntity<PagedResources<Endereco>> findEnderecosByPessoa(@PathVariable("pessoaId") java.lang.String pessoaId, Pageable pageable, PagedResourcesAssembler assembler) {
